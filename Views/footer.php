    ...
    <div class="container py-lg-4">
      <div class="row footer-top-29">
        <div class="col-lg-3 col-md-6 col-sm-8 footer-list-29 footer-1">
          ...
          <ul>
            <li>
              <p><span class="fa fa-map-marker"></span> Sahjanand hotel, Sanand, </p>
              <p>Gujarat, India</p>
            </li>
            <li><a href="1-234-567-890"><span class="fa fa-phone"></span> 123-456-7890</a></li>
            <li><a href="mailto:hotels@mail.com" class="mail"><span class="fa fa-envelope-open-o"></span>
                hotels@gmail.com</a></li>
          </ul>
        </div>
        ...
        <div class="col-lg-2 col-md-6 col-sm-4 footer-list-29 footer-2 mt-sm-0 mt-5">
          <ul>
            <h6 class="footer-title-29">Feedback Form</h6>
