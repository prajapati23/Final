        ...
        <div class="container">
            <div class="d-grid contact-view">
                ...
                <div class="map-content-9">
                    <p>Use the Access Contacts to keep track of names, addresses, telephone numbers, and other information. This new version of a popular Access template also lets you categorize each contact, send e-mail messages, and create maps of addresses.</p>
                </div>
            </div>
            ...
            <div class="d-grid contact-view my-5">
                <div class="cont-details">
                    <div class="cont-top">
                    ...
                    <div class="cont-top margin-up">
                        ...
                        <div class="cont-right">
                            <h6>Address</h6>
                            <p>Address here, 208 Nirman Tower, Sayona City , Sola</p>
                        </div>
                    </div>
                </div>
